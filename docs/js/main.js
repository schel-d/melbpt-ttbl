...
function getOnScreenCells(editor, rows, cols) {
    ...
    const editorJQuery = (0, jquery_1.default)(editor.html.editor);
...
function editorInit(editor) {
    ...
    (0, jquery_1.default)(editor.html.editor).on("scroll", () => {
        editor.events.mouseOver = null;
        editor.draw();
    });
...
},{"./editor":5,"./network":7,"./new-timetable-dialog":8}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
